      ...
      <div className="w-full max-w-5xl grid md:grid-cols-2 sm:gap-8 gap-2">
        ...
        <div className="hidden md:flex flex-col items-center">
          <div className="text-center mb-4">
            ...
            <p className="text-sm text-gray-500">상담사님을 위한 핵심 서비스를 소개합니다</p>
          </div>
        ...
        <div className="flex flex-col justify-center space-y-6">
          <div className="hidden md:block text-center mb-8">
            ...
            <p className="text-gray-500">마음읽기와 함께 더 나은 상담 서비스를 제공하세요</p>
          </div>
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormControl>
                      <Input placeholder="이메일을 입력하세요" className="h-12 px-4" {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <Button asChild type="button" variant="secondary" className="w-full h-12 text-base">
